...
QList<ConversionPipeTrunk> soundkonverter_ripper_cdparanoia::codecTable()
{
    ...
    newTrunk.problemInfo = i18n(
        "In order to rip audio cds per track or to a single file, you need to install 'cdparanoia'.\n'cdparanoia' is usually shipped with your distribution, "
        "the package name can vary.");
