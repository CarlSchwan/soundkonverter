...
public:
    ...
    QList<ConversionPipe> getConversionPipes(const QString &codecFrom,
                                             const QString &codecTo,
                                             QList<FilterOptions *> filterOptions = QList<FilterOptions *>(),
                                             const QString &preferredPlugin = ""); // TODO change name ?
    ...
    QList<CodecPlugin *> getAllCodecPlugins()
    {
        return codecPlugins;
    }
    /** returns a list of all plugins e.g. for connecting their signals */
    QList<FilterPlugin *> getAllFilterPlugins()
    {
        return filterPlugins;
    }
    /** returns a list of all plugins e.g. for connecting their signals */
    QList<ReplayGainPlugin *> getAllReplayGainPlugins()
    {
        return replaygainPlugins;
    }
    /** returns a list of all plugins e.g. for connecting their signals */
    QList<RipperPlugin *> getAllRipperPlugins()
    {
        return ripperPlugins;
    }
